...
### WP-01 -- Fit the socials handle to its pane, red test first (status: Not Started)
...
- AC-01.2 (non-test) vc reads the portrait socials frame of Snokeltoast 001 with the handle forbiddenplanetnottingham and finds it whole, inside the safe margin, and legible -- satisfied: no
