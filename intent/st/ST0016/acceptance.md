...
- AT01 `opt/utilz/test/help_dispatch.bats` -- covers AC01 -- status: green

### Group AT02

- AT02 `opt/utilz/test/help_dispatch.bats` -- covers AC02 -- status: green

### Group AT03

- AT03 `opt/utilz/test/help_dispatch.bats` -- covers AC03 -- status: green

### Group AT04

- AT04 `opt/utilz/test/help_dispatch.bats` -- covers AC04 -- status: green

### Group AT05

- AT05 `opt/utilz/test/help_dispatch.bats` -- covers AC05 -- status: green

### Group AT06

- AT06 `opt/utilz/test/help_dispatch.bats` -- covers AC06 -- status: green

### Group AT07

- AT07 `opt/utilz/test/help_dispatch.bats` -- covers AC07 -- status: green
