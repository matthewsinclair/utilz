...
| WP-05 | Default theme polish: basic but cool enough out of the box         | S    | Cancelled |
| WP-06 | Theme addressing split + --theme-path (hv's CLI asks)              | S    | Cancelled |
| WP-07 | Expose theme determinism checking as a prez capability (deferred)  | S    | Done      |
