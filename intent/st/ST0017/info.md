...
| ----- | -------------------------------------------------------------------------------- | ---- | ----------- |
| WP-01 | Workspace + artifact crate: the C3 consolidation, zero behaviour change to prez  | S    | Not Started |
| WP-02 | Fidelity harness, red-proved against population 1 (Python both sides)            | S    | Not Started |
| WP-03 | Rust build path: YAML, admission (C1), normalisation policy (C2), data-URI       | S    | Not Started |
