...
heartbeat_at: 2026-09-09 19:04Z
status: active
focus: "ST0017: 42/51, 3 withdrawn, doctor 0. hv AFK, vc has the pen, both peers taking instruction. AC-3.6 runtime leg SPECIFIED and sent to cc before the template-pull commit -- the harness is BLIND to it, so two source checks are the only mechanism. AC-3.2 names report_unused population; AC-3.8 evidence corrected; AC-3.6 cites facts that survive hv item 2. AC-3.4 and AC-4.2 both have their empty-population limits stated. GO given on the template pull. Every open row is now audited ahead of its code."
claims: [ST0017]
---
