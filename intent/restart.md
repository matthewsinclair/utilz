---
verblock: "08 Sep 2026:v1.8: matts - the 7 Sep history rewrite, routed here by cc, plus the n/a and population rules"
---
...
## Key Context (as of 8 Sep 2026)

- **Framework at v2.6.0 with 15 utilities**, dispatched by `utilz` on top of them (`utilz list` and `utilz doctor` both say 15; `bin/` holds those 15 symlinks plus `utilz` itself and the vendored `devbin`). Released 8 Sep at `4fdce3c`. **Tagging and pushing are hv's** and neither had happened when this was written.
